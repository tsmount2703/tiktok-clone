        ...
        <div className="w-full mt-[80px] mb-[40px] bg-white shadow-lg rounded-md py-6 md:px-10 px-4">
          ...
          <div className="mt-8 md:flex gap-6">
            {!fileDisplay ? (
              <label
                htmlFor="fileInput"
                className="md:mx-0 mx-auto mt-4 mb-6 flex flex-col items-center justify-center w-full max-w-[260px] h-[470px] text-center font-semibold p-3 border-2 border-dashed border-gray-300 rounded-lg hover:bg-gray-100 cursor-pointer"
              >
              ...
              <div className="flex bg-[#F8F8F8] py-4 px-6">
                ...
                <div>
                  ...
                  <div className="font-semibold text-[15px text-gray-400">
                    ...
                    remove redundant parts and turn landscape videos into
                    portrait videos
                  </div>
                </div>
